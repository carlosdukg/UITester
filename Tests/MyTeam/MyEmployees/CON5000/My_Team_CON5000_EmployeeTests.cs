...
namespace UltiProTests.Tests.MyTeam.MyEmployees.CON5000
{
    [TestClass]
    public class My_Team_CON5000_EmployeeTests
    {
        ...
        public async Task Hire_Employee()
        {
            ...
            var uiTest = await _testHelper
                .LoadUITest(@"DataTemplates/MyTeam/MyEmployees/CON5000/add-employee.json");
